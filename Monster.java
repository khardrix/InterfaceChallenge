...
public class Monster implements ISaveable {
    ...
    public Monster(String name, String weapon, int currentHealth) {
        ...
        if(currentHealth > 0 && currentHealth <= 1000){
            ...
            System.out.println("The value for currentHealth must be between 1 and 1000. " +
                    "\nBy default, the monster's currentHealth field will be set to " +
                    "the low level monster value of 100.");
    ...
    public ArrayList valuesToBeSaved() {
        ...
        System.out.println("\n" + this.name + " is the name of the monster. " + this.name + " has been saved. " +
    ...
    public String toString() {
        ...
        return "The monster named " + this.name + " is wielding a " + this.weapon +
                ". The monster started with " + this.currentHealth + " hit points for health.";
    }
